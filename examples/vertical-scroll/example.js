...
var collectionViewSize = new Models.Size({height: 608, width:256});
var cellSize = new Models.Size({height:collectionViewSize.width, width: collectionViewSize.width});
...
for(var i = 0; i < numberImages; i++) {
    ...
    images.push(new SimpleImageFactory(_images[_imagesIndex], i));
    _imagesIndex++;
}
...
var contentSize = new Models.Size({
    ...
    height: cellSize.height*numberImages
});
